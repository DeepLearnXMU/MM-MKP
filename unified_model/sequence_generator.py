...
class Beam:
    ...
    def advance(self, word_logits, attn_dist):
        ...
        * `attn_dist`- attention at the last step [beam_size, src_len]
        ...
        prev_k =(best_scores_idx / vocab_size).long()
...
class SequenceGenerator(object):
    ...
    def beam_search(self, src, src_lens, src_oov, src_mask, oov_lists, img=None, attr=None,type=None):
        """
        ...
        # Encoding
        memory_bank, encoder_final_state, img_feats, attr_feats, combined_feat,text2img_attn,_ = \
            self.model.encoder(src, src_lens, src_mask, img, attr,type)
