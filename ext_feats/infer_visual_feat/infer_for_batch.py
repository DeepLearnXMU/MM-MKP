...
import time
from data_loader import get_tweet_img_loader
...
def main(args):
    ...
    for type_tag in ['train', 'test']:  # 'train', 'valid', 'test'
        t0 = time.time()
        img_fn = args.img_fn.format(type_tag)
        pred_fn = args.pred_fn.format(type_tag, args.img_ext_model)

        # Load the trained model parameters
        data_loader = get_tweet_img_loader(args.img_dir, img_fn, args.batch_size,type_tag)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_dir', type=str, default='/home/sata/dyfff/Twitter_images', help='')
    # /research/lyu1/yuewang/workspace/MMKG_images
    #
    parser.add_argument('--img_fn', type=str, default='/home/dyfff/new/CMKP/data/textimage-data.csv', help='')
    #/home/dyfff/new/CMKP/data/
    parser.add_argument('--pred_fn', type=str, default='/home/dyfff/new/CMKP/data/tw_mm_s1_ocr/{}_itm_img_{}.pt', help='')
    #/home/dyfff/new/CMKP/data/tw_mm_s4/
    parser.add_argument('--img_ext_model', type=str, choices=['resnet', 'vgg', 'complex_resnet'],
                        default='complex_resnet', help='')
