...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_dir', type=str, default='/home/sata/dyfff/CMKP_images/CMKP_images', help='')
    # /research/lyu1/yuewang/workspace/MMKG_images
    parser.add_argument('--img_fn', type=str, default='/home/dyfff/new/CMKP/data/tw_mm_s1_ocr/{}_src.txt', help='')
    parser.add_argument('--pred_fn', type=str, default='/home/dyfff/new/CMKP/data/tw_mm_s1_ocr/{}_img_{}.pt', help='')
